    ...
    public partial class initialmigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ApplicationUserId = table.Column<string>(type: "TEXT", nullable: false),
                    ApplicationFriendId = table.Column<string>(type: "TEXT", nullable: false),
                    Status = table.Column<string>(type: "TEXT", nullable: false, defaultValue: "NotFriends")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Friends", x => new { x.ApplicationUserId, x.ApplicationFriendId });
                    table.ForeignKey(
                        name: "FK_Friends_AspNetUsers_ApplicationFriendId",
                        column: x => x.ApplicationFriendId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    StatusLike = table.Column<bool>(type: "INTEGER", nullable: false),
                    ApplicationUserId = table.Column<string>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TweetLikes_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Friends_ApplicationFriendId",
                table: "Friends",
                column: "ApplicationFriendId");

            migrationBuilder.CreateIndex(
                name: "IX_TweetLikes_ApplicationUserId",
                table: "TweetLikes",
                column: "ApplicationUserId");
